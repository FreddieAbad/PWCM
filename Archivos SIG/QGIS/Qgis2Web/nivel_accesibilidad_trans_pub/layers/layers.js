...
jsonSource_TransportePublicoCob_500m_3.addFeatures(features_TransportePublicoCob_500m_3);var lyr_TransportePublicoCob_500m_3 = new ol.layer.Vector({
            ...
            });var format_TransporteUrbanoCob_500m_4 = new ol.format.GeoJSON();
var features_TransporteUrbanoCob_500m_4 = format_TransporteUrbanoCob_500m_4.readFeatures(json_TransporteUrbanoCob_500m_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TransporteUrbanoCob_500m_4 = new ol.source.Vector({
    attributions: '<a href=""></a>',
});
jsonSource_TransporteUrbanoCob_500m_4.addFeatures(features_TransporteUrbanoCob_500m_4);var lyr_TransporteUrbanoCob_500m_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_TransporteUrbanoCob_500m_4, 
                style: style_TransporteUrbanoCob_500m_4,
                title: '<img src="styles/legend/TransporteUrbanoCob_500m_4.png" /> Transporte Urbano Cob_500m'
            });

lyr_CapaBaseOSM_0.setVisible(true);lyr_LimitesParroquialesCuenca_1.setVisible(true);lyr_LimiteUrbanoCuenca_2.setVisible(true);lyr_TransportePublicoCob_500m_3.setVisible(true);lyr_TransporteUrbanoCob_500m_4.setVisible(true);
var layersList = [lyr_CapaBaseOSM_0,lyr_LimitesParroquialesCuenca_1,lyr_LimiteUrbanoCuenca_2,lyr_TransportePublicoCob_500m_3,lyr_TransporteUrbanoCob_500m_4];
...
lyr_TransporteUrbanoCob_500m_4.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
...
lyr_TransporteUrbanoCob_500m_4.set('fieldImages', {'OBJECTID': '', 'Shape_Leng': '', 'Shape_Area': '', });
...
lyr_TransporteUrbanoCob_500m_4.set('fieldLabels', {'OBJECTID': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_TransporteUrbanoCob_500m_4.on('precompose', function(evt) {
